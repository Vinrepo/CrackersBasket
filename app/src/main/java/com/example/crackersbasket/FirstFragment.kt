...
import com.example.crackersbasket.ImageSliderAdapter
...
class FirstFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        childList1.add(Child("10CM ELECTRIC SPARKLER  ₹66/5box"));
        childList1.add(Child("10CM COLOUR SPARKLER ₹70/5box"));
        childList1.add(Child("12CM ELECTRIC SPARKLER ₹88/5box"));
        childList1.add(Child("Chicken 65(4 pcs) ₹110"));

        val sections: MutableList<SectionHeader> = ArrayList();
        sections.add(SectionHeader(childList1, "SPARKLER ITEMS"));

        val childList2: MutableList<Child> = ArrayList();
        childList2.add(Child("Veg Biriyani        ₹50/pack"));
        sections.add(SectionHeader(childList2, "FLOWER POTS"));
   ...
   private fun checkPermission(vararg perm:String) : Boolean {
    ...
    private fun imageSliderImplementation() {
        ...
        val adapter =
            ImageSliderAdapter(requireContext())
