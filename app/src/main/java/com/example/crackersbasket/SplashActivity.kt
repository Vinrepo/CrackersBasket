...
import com.example.crackersbasket.DatabaseHandler
import com.example.crackersbasket.EmpModelClass
import com.example.crackersbasket.LatlongClass
import com.example.crackersbasket.ShopClosedActivity
...
class SplashActivity : AppCompatActivity() {
    ...
    fun saveRecord(context: Context?){
        ...
        if(lat.trim()!=""&& long.trim()!=""){
            val status = databaseHandler.addLatlong(
                LatlongClass(
                    lat,
                    long
                )
    ...
    fun updateRecord(context: Context?){
        ...
        if(lat.trim()!=""&& long.trim()!=""){
            ...
            val status = databaseHandler.updatelatlong(
                LatlongClass(
                    lat,
                    long
                )
